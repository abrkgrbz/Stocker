...
import { useLeaveRequest, useUpdateLeaveRequest, useEmployees } from '@/lib/api/hooks/useHR';
...
export default function EditLeaveRequestScreen() {
    ...
    const { data: leaveRequest, isLoading: isLoadingLeave } = useLeaveRequest(id || '');
    ...
    const handleSubmit = () => {
        ...
        updateLeaveRequest(
            ...
            {
                onSuccess: () => {
                    Alert.alert('Başarılı', 'İzin talebi başarıyla güncellendi', [
                        { text: 'Tamam', onPress: () => router.back() }
                    ]);
                },
                onError: () => {
                    Alert.alert('Hata', 'İzin talebi güncellenirken bir hata oluştu');
                }
            }
        );
    };
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.background.secondary }} edges={['top']}>
            ...
            >
                        ...
                        <View className="flex-row items-center flex-1">
                            ...
                            <View>
                                ...
                                <Text style={{ color: colors.text.tertiary, fontSize: 13 }}>
                                    {leaveRequest?.employeeName || 'Yükleniyor...'}
                                </Text>
                            </View>
                        </View>
                ...
                >
                    {/* Employee Selection (Read-only for edit) */}
