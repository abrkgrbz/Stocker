...
import type { CreateQuoteItemRequest } from '@/lib/api/types/sales.types';

interface QuoteItem extends CreateQuoteItemRequest {
    productName?: string;
}
                    ...
                    <Animated.View entering={FadeInDown.duration(400).delay(120)}>
                        <View
                            style={{
                                ...
                                marginBottom: 16,
                                borderWidth: 1,
                                borderColor: errors.validUntil ? colors.semantic.error : colors.border.primary
                            }}
                        >
                            <View className="flex-row items-center mb-4">
                                <View
                                ...
                                >
                                    <Calendar size={20} color={colors.semantic.warning} />
                                </View>
                                <Text style={{ color: colors.text.primary, fontSize: 16, fontWeight: '600' }}>
                                    Geçerlilik Tarihi *
                                </Text>
                        ...
                        >
                            <View className="flex-row items-center justify-between mb-4">
                                <View className="flex-row items-center">
                                    ...
                                    >
                                        <FileQuote size={20} color={colors.modules.inventory} />
                                    </View>
                                    <Text style={{ color: colors.text.primary, fontSize: 16, fontWeight: '600' }}>
                                        Ürünler *
                                    </Text>
