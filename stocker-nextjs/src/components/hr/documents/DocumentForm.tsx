...
export default function DocumentForm({ form, initialValues, onFinish, loading }: DocumentFormProps) {
      ...
      <Row gutter={48}>
        ...
        <Col xs={24} lg={10}>
          ...
          <div className="mb-8">
            ...
            >
              <FileOutlined style={{ fontSize: '64px', color: 'rgba(255,255,255,0.9)' }} />
              <p className="mt-4 text-lg font-medium text-white/90">Belge Kaydı</p>
              <p className="text-sm text-white/60">Çalışan belgelerini yönetin</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-blue-50/50 rounded-xl border border-blue-100">
            ...
            <div className="text-xs text-blue-600">
              Belge kaydı oluşturduktan sonra dosya yükleme işlemi yapabilirsiniz.
            </div>
          </div>
          ...
          {initialValues && initialValues.fileName && (
            <div className="grid grid-cols-1 gap-3 mt-6">
              <div className="p-4 bg-gray-50/50 rounded-xl">
                ...
                <div className="text-sm font-medium text-gray-800">{initialValues.fileName}</div>
              </div>
            </div>
          )}
        </Col>
