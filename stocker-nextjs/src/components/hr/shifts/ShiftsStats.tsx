...
export function ShiftsStats({ shifts, loading = false }: ShiftsStatsProps) {
  ...
  const stats = [
    ...
    },
    {
      title: 'Aktif Vardiya',
      value: activeShifts,
      subtitle: `${totalShifts > 0 ? ((activeShifts / totalShifts) * 100).toFixed(1) : 0}% Aktif Oran`,
    ...
    },
    {
      ...
      value: nightShifts,
      subtitle: 'Gece Çalışma Vardiyaları',
      icon: MoonIcon,
      color: '#3b82f6',
    },
  ];
