    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-100">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Gizlilik Politikasi</h1>
        ...
        <div className="space-y-8">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">1</span>
              Giris
            </h2>
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">2</span>
              Toplanan Veriler
            </h2>
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <h3 className="font-semibold text-white mb-2">Kullanim Verileri</h3>
                <ul className="list-disc list-inside space-y-1 ml-4 text-gray-400">
              ...
              <div>
                <h3 className="font-semibold text-white mb-2">Is Verileri</h3>
                <ul className="list-disc list-inside space-y-1 ml-4 text-gray-400">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">3</span>
              Verilerin Kullanimi
            </h2>
            <p className="text-gray-300 mb-4">Toplamis oldugumuz verileri asagidaki amaclarla kullaniyoruz:</p>
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">4</span>
              Veri Guvenligi
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="p-4 bg-gradient-to-r from-emerald-900/30 to-teal-900/30 rounded-xl border border-emerald-700/30">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">5</span>
              Kullanici Haklari
            </h2>
            <p className="text-gray-300 mb-4">KVKK ve GDPR kapsaminda asagidaki haklara sahipsiniz:</p>
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">6</span>
              Cerezler (Cookies)
            </h2>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-gray-700/30 rounded-lg">
                <span className="font-semibold text-white">Zorunlu Cerezler:</span>
                <span className="text-gray-400 ml-2">Oturum yonetimi ve guvenlik icin gereklidir</span>
              </div>
              <div className="p-3 bg-gray-700/30 rounded-lg">
                <span className="font-semibold text-white">Performans Cerezleri:</span>
                <span className="text-gray-400 ml-2">Hizmet iyilestirme icin anonim veriler toplar</span>
              </div>
              <div className="p-3 bg-gray-700/30 rounded-lg">
                <span className="font-semibold text-white">Tercih Cerezleri:</span>
                <span className="text-gray-400 ml-2">Kullanici tercihlerini hatirlar</span>
              </div>
            </div>
          </motion.section>
          ...
          <motion.section
            ...
            className="p-6 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-2xl border border-purple-700/30"
          >
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 text-white text-sm font-bold">7</span>
              Iletisim
            </h2>
            <p className="text-gray-300 mb-4">
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <Link href="/privacy" className="text-purple-400">Gizlilik</Link>
