...
import type { UpdateQuotationDto } from '@/lib/api/services/sales.service';
...
export default function EditQuotationPage() {
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      message.success('Teklif güncellendi');
  ...
  if (quotation.status !== 'Draft') {
    return (
      <div style={{ padding: 24 }}>
        <Text type="danger">Sadece taslak durumundaki teklifler düzenlenebilir</Text>
        <br />
        <Button onClick={() => router.push(`/sales/quotations/${id}`)} style={{ marginTop: 16 }}>
          Detaya Dön
        </Button>
      </div>
    );
          ...
          <Col span={8}>
            ...
            <Card title="Özet" style={{ position: 'sticky', top: 24 }}>
              ...
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Button block onClick={() => router.push(`/sales/quotations/${id}`)}>
                  İptal
                </Button>
              </Space>
            </Card>
