...
import { useCreateBillOfMaterial } from '@/lib/api/hooks/useManufacturing';
import type { CreateBillOfMaterialRequest } from '@/lib/api/services/manufacturing.types';

export default function NewBillOfMaterialPage() {
  const router = useRouter();
  const [form] = Form.useForm();
  const createBom = useCreateBillOfMaterial();
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 m-0">Ürün için malzeme listesi oluşturun</p>
            </div>
          </div>
          <Space>
