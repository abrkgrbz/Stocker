...
import { ArrowLeftOutlined, SaveOutlined, ClockCircleOutlined, UserOutlined, FieldTimeOutlined } from '@ant-design/icons';
      ...
      <div className="sticky top-0 z-50 px-8 py-4" style={{ background: 'rgba(255, 255, 255, 0.8)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(0, 0, 0, 0.06)' }}>
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <Space>
            ...
            <Button type="primary" icon={<SaveOutlined />} loading={updateTimeSheet.isPending} onClick={() => form.submit()} style={{ background: '#1a1a1a', borderColor: '#1a1a1a' }}>Kaydet</Button>
          </Space>
        </div>
      </div>
