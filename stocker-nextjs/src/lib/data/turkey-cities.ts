...
export const TURKEY_CITIES: City[] = [
  ...
  {
    name: 'Ankara',
    districts: ['Akyurt', 'Altındağ', 'Ayaş', 'Balâ', 'Beypazarı', 'Çamlıdere', 'Çankaya', 'Çubuk', 'Elmadağ', 'Etimesgut', 'Evren', 'Gölbaşı', 'Güdül', 'Haymana', 'Kalecik', 'Kazan', 'Keçiören', 'Kızılcahamam', 'Mamak', 'Nallıhan', 'Polatlı', 'Pursaklar', 'Sincan', 'Şereflikoçhisar', 'Yenimahalle'],
  },
  {
    name: 'Antalya',
  ...
  {
    name: 'Konya',
    districts: ['Ahırlı', 'Akören', 'Akşehir', 'Altınekin', 'Beyşehir', 'Bozkır', 'Cihanbeyli', 'Çeltik', 'Çumra', 'Derbent', 'Derebucak', 'Doğanhisar', 'Emirgazi', 'Ereğli', 'Güneysinır', 'Hadim', 'Halkapınar', 'Hüyük', 'Ilgın', 'Kadınhanı', 'Karapınar', 'Karatay', 'Kulu', 'Meram', 'Sarayönü', 'Selçuklu', 'Seydişehir', 'Taşkent', 'Tuzlukçu', 'Yalıhüyük', 'Yunak'],
  },
  {
    name: 'Kütahya',
  ...
  {
    name: 'Tokat',
    districts: ['Almus', 'Artova', 'Başçiftlik', 'Erbaa', 'Niksar', 'Pazar', 'Reşadiye', 'Sulusaray', 'Turhal', 'Yeşilyurt', 'Zile', 'Merkez'],
  },
  {
    name: 'Trabzon',
...
export const getCityNames = (): string[] => {
  return TURKEY_CITIES.map((city) => city.name).sort();
};
...
export const getCityByDistrict = (districtName: string): string | null => {
  const city = TURKEY_CITIES.find((c) => c.districts.includes(districtName));
