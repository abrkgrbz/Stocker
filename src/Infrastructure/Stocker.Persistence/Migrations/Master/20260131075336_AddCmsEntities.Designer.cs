...
namespace Stocker.Persistence.Migrations.Master
{
    ...
    [Migration("20260131075336_AddCmsEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.AddOn", b =>
                {
                    ...
                    b.Property<string>("RequiredModuleCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.CmsMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CmsMedia", "cms");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.CmsPage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CmsPages", "cms");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.DocItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.IyzicoSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CustomerGsmNumber")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("IyzicoParentReferenceCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("IyzicoCustomerReferenceCode")
                    ...
                    b.ToTable("IyzicoSubscriptions", "master");
                });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModuleBundle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ModuleBundles", "master");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModuleBundleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ModuleBundleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ModuleBundleId", "ModuleCode")
                        .IsUnique()
                        .HasDatabaseName("IX_ModuleBundleItems_BundleId_ModuleCode");

                    b.ToTable("ModuleBundleItems", "master");
                });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModulePricing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ModulePricing", "master");
                });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.Package", b =>
                {
                    ...
                    b.Property<string>("IyzicoPlanId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("IyzicoProductId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("Packages", "master", t =>
                        {
                            t.Property("MaxUsers")
                                .HasColumnName("Package_MaxUsers");
                        });
                });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionAddOn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SubscriptionAddOns", "master");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionCart", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SubscriptionCarts", "master");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionCartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("IncludedModuleCodesJson")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PaymentProviderOrderId")
                    ...
                    b.ToTable("SubscriptionOrders", "master");
                });

            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ActivationError")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("OrderId", "ItemType")
                        .HasDatabaseName("IX_SubscriptionOrderItems_OrderId_ItemType");

                    b.ToTable("SubscriptionOrderItems", "master");
                });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.AddOn", b =>
                {
                    ...
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "YearlyPrice", b1 =>
                        {
                            b1.Property<Guid>("AddOnId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.BlogPost", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.MasterUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Stocker.Domain.Master.Entities.CMS.BlogCategory", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.CmsMedia", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.MasterUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.CMS.DocItem", b =>
                {
                    ...
                    b.HasOne("Stocker.Domain.Master.Entities.CMS.DocItem", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModuleBundle", b =>
                {
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "MonthlyPrice", b1 =>
                        {
                            b1.Property<Guid>("ModuleBundleId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ModuleBundleId");

                            b1.ToTable("ModuleBundles", "master");

                            b1.WithOwner()
                                .HasForeignKey("ModuleBundleId");
                        });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModuleBundleItem", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.ModuleBundle", null)
                        .WithMany("Modules")
                        .HasForeignKey("ModuleBundleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.ModulePricing", b =>
                {
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "MonthlyPrice", b1 =>
                        {
                            b1.Property<Guid>("ModulePricingId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ModulePricingId");

                            b1.ToTable("ModulePricing", "master");

                            b1.WithOwner()
                                .HasForeignKey("ModulePricingId");
                        });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionAddOn", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.AddOn", "AddOn")
                        .WithMany()
                        .HasForeignKey("AddOnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Stocker.Domain.Master.Entities.Subscription", "Subscription")
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionAddOnId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("SubscriptionAddOnId");

                            b1.ToTable("SubscriptionAddOns", "master");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionCartItem", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.SubscriptionCart", null)
                        .WithMany("Items")
                    ...
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "UnitPrice", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionCartItemId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("SubscriptionCartItemId");

                            b1.ToTable("SubscriptionCartItems", "master");

                            b1.WithOwner()
                                .HasForeignKey("SubscriptionCartItemId");
                        });
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionOrder", b =>
                {
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "DiscountTotal", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionOrderId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("SubscriptionOrders", "master");
                    ...
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "Total", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionOrderId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Stocker.Domain.Master.Entities.SubscriptionOrderItem", b =>
                {
                    b.HasOne("Stocker.Domain.Master.Entities.SubscriptionOrder", null)
                        .WithMany("Items")
                    ...
                    b.OwnsOne("Stocker.Domain.Common.ValueObjects.Money", "LineTotal", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionOrderItemId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("SubscriptionOrderItemId");

                            b1.ToTable("SubscriptionOrderItems", "master");

                            b1.WithOwner()
                                .HasForeignKey("SubscriptionOrderItemId");
                        });
