...
{
    /// <inheritdoc />
    public partial class InitialPostgreSQL_Tenant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserLimit = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    StorageLimit = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    RecordLimit = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
