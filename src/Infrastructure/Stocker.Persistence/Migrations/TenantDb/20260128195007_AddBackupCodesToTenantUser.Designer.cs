...
namespace Stocker.Persistence.Migrations.TenantDb
{
    ...
    [Migration("20260128195007_AddBackupCodesToTenantUser")]
    partial class AddBackupCodesToTenantUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stocker.Domain.Tenant.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "RoomName", "SentAt")
                    ...
                    b.HasIndex("TenantId", "SenderId", "RecipientId", "SentAt")
                        .HasDatabaseName("IX_ChatMessages_TenantId_SenderId_RecipientId_SentAt");

                    b.ToTable("ChatMessages", "tenant");
                });
