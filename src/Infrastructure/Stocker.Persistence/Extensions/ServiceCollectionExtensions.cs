...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Register ITenantUnitOfWork using a lazy proxy pattern
        // This ensures it's only created when actually needed and tenant is already resolved
        services.AddScoped<ITenantUnitOfWork, LazyTenantUnitOfWork>();
