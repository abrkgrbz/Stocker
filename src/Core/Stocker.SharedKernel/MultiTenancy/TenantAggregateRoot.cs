...
public abstract class TenantAggregateRoot : AggregateRoot, ITenantEntity, ISoftDeletable
{
...
public abstract class TenantAggregateRoot<TId> : AggregateRoot<TId>, ITenantEntity, ISoftDeletable
    where TId : notnull
{
    public Guid TenantId { get; private set; }
