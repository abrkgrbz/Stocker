...
/// <summary>
/// Command to record a payment for consignment stock
/// </summary>
public class RecordConsignmentPaymentCommand : IRequest<Result<ConsignmentStockDto>>
{
    public Guid TenantId { get; set; }
    public int ConsignmentStockId { get; set; }
    public RecordConsignmentPaymentDto Data { get; set; } = null!;
}

/// <summary>
/// Validator for RecordConsignmentPaymentCommand
/// </summary>
public class RecordConsignmentPaymentCommandValidator : AbstractValidator<RecordConsignmentPaymentCommand>
{
    public RecordConsignmentPaymentCommandValidator()
    {
        ...
        RuleFor(x => x.Data).NotNull().WithMessage("Ödeme verileri gereklidir");
        RuleFor(x => x.Data.Amount).GreaterThan(0).WithMessage("Ödeme tutarı 0'dan büyük olmalıdır");
    }
}

/// <summary>
/// Handler for RecordConsignmentPaymentCommand
/// </summary>
public class RecordConsignmentPaymentCommandHandler : IRequestHandler<RecordConsignmentPaymentCommand, Result<ConsignmentStockDto>>
{
    private readonly IInventoryUnitOfWork _unitOfWork;

    public RecordConsignmentPaymentCommandHandler(IInventoryUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }

    public async Task<Result<ConsignmentStockDto>> Handle(RecordConsignmentPaymentCommand request, CancellationToken cancellationToken)
    {
        ...
        consignment.RecordPayment(request.Data.Amount, request.Data.ReferenceNumber);
