...
namespace Stocker.Modules.HR.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddSoftDeleteColumnsV2 : Migration
    {
        ...
        {
            // Add soft delete columns to all HR tables using idempotent SQL
            var tables = new[]
            {
                "audit_logs",
                "Announcements",
            ...
            {
                AddSoftDeleteColumnsToTable(migrationBuilder, "hr", tableName);
            }
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            foreach (var tableName in tables)
            {
                RemoveSoftDeleteColumnsFromTable(migrationBuilder, "hr", tableName);
            }
        }
