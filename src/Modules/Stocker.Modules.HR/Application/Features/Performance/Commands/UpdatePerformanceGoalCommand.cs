...
/// </summary>
public class UpdatePerformanceGoalCommand : IRequest<Result<PerformanceGoalDto>>
{
    public Guid TenantId { get; set; }
    public int GoalId { get; set; }
    public UpdatePerformanceGoalDto GoalData { get; set; } = null!;
}
...
public class UpdatePerformanceGoalCommandHandler : IRequestHandler<UpdatePerformanceGoalCommand, Result<PerformanceGoalDto>>
{
    ...
    public UpdatePerformanceGoalCommandHandler(
