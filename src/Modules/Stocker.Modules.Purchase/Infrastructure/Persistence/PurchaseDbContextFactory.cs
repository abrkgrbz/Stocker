...
/// <summary>
/// Design-time factory for Purchase DbContext
...
public class PurchaseDbContextFactory : IDesignTimeDbContextFactory<PurchaseDbContext>
{
    public PurchaseDbContext CreateDbContext(string[] args)
    {
        ...
        {
            options.MigrationsAssembly(typeof(PurchaseDbContext).Assembly.FullName);
            options.MigrationsHistoryTable("__EFMigrationsHistory", "purchase");
            options.CommandTimeout(30);
        });

        // Create a dummy tenant service for design-time
        var tenantService = new PurchaseDesignTimeTenantService();
...
/// </summary>
public class PurchaseDesignTimeTenantService : ITenantService
{
