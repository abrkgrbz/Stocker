...
/// <summary>
/// Base repository implementation for Purchase module
/// </summary>
public abstract class BaseRepository<TEntity> : BaseRepository<TEntity, Guid>, IRepository<TEntity>
    where TEntity : Entity<Guid>
{
    protected BaseRepository(PurchaseDbContext context) : base(context)
    {
    }
}
    ...
    where TId : notnull
{
    ...
    protected BaseRepository(PurchaseDbContext context)
    {
        _context = context;
