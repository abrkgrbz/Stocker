...
public class PauseCampaignCommand : IRequest<Result<CampaignDto>>, ITenantRequest
{
...
public class PauseCampaignCommandHandler : IRequestHandler<PauseCampaignCommand, Result<CampaignDto>>
{
    private readonly CRMDbContext _context;

    public PauseCampaignCommandHandler(CRMDbContext context)
    {
        _context = context;
    }

    public async Task<Result<CampaignDto>> Handle(PauseCampaignCommand request, CancellationToken cancellationToken)
    {
