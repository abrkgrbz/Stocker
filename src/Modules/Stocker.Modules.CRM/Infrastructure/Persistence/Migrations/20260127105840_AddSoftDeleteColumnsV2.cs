...
namespace Stocker.Modules.CRM.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddSoftDeleteColumnsV2 : Migration
    {
        ...
        {
            // Add soft delete columns to all CRM tables using idempotent SQL
            var tables = new[]
            {
                "Accounts",
                "Activities",
            ...
            {
                AddSoftDeleteColumnsToTable(migrationBuilder, "crm", tableName);
            }
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            foreach (var tableName in tables)
            {
                RemoveSoftDeleteColumnsFromTable(migrationBuilder, "crm", tableName);
            }
        }
