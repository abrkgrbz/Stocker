...
namespace Stocker.Modules.Sales.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260129175737_AddSalesCustomerAndSalesProductEntities")]
    partial class AddSalesCustomerAndSalesProductEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stocker.Modules.Sales.Domain.Entities.SalesCustomer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("EInvoiceLastCheckedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("TenantId", "CrmCustomerId")
                    ...
                    b.ToTable("SalesCustomers", "sales");
                });
            ...
            modelBuilder.Entity("Stocker.Modules.Sales.Domain.Entities.SalesProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsPriceIncludingVat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<decimal?>("SpecialConsumptionTaxAmount")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal?>("SpecialConsumptionTaxRate")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");
                    ...
                    b.HasIndex("TenantId", "InventoryProductId")
                    ...
                    b.HasIndex("TenantId", "IsActive", "IsAvailableForSale")
                        .HasDatabaseName("IX_SalesProducts_TenantId_IsActive_IsAvailableForSale");

                    b.ToTable("SalesProducts", "sales");
                });
