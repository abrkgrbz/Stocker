    ...
    return (
        <div className="min-h-screen font-sans flex relative overflow-x-hidden bg-brand-950 text-text-main transition-colors duration-300">
            ...
            <main className="flex-1 min-h-screen relative z-10 flex flex-col min-w-0">
                {/* Top Navigation - Standard Themed */}
                <header className="flex items-center justify-between px-8 py-4 m-8 glass-card mx-8 mt-8 mb-4 border-border-subtle">
                    <div className="flex items-center gap-4">
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                placeholder="Talep veya yardım makalesi ara..."
                                className="bg-indigo-500/5 border border-border-subtle rounded-2xl py-3 pl-12 pr-6 text-sm placeholder:text-text-muted focus:outline-none focus:border-indigo-500/30 w-96 transition-all text-text-main"
                            />
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="text-right hidden sm:block">
                            <p className="text-xs font-bold text-text-main tracking-wide transition-colors duration-300">Destek Paneli</p>
                            <p className="text-[10px] text-text-muted uppercase tracking-widest font-bold transition-colors duration-300">Stocker V2</p>
                        </div>
                    </div>
                </header>
